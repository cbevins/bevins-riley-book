...
async function runMissing() {
    ...
    console.log('The GedcomPlaces.js file is missing the following PLAC contents:')
    const all = new Map()
...
// Returns an array of the 'selected' elements that are not present in GedcomPlaces
