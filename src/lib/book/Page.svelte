...
<div class='relative w-[8.5in] h-[11in] border-2 border-slate-400'>
    <PageHeader left={hl} center={hc} right={hr}/>
    <PageContent><slot></slot></PageContent>
    <PageFooter left={fl} center={fc} right={fr}/>
</div>
