<script>
    // body/USA/publish.svelte is invoked by lib/publish/Publish.svelte
    import { P, Publish, SectionPlaceholder } from '$lib/publish'
    import MN from './MN/publish.svelte'
    import MT from './MT/publish.svelte'
