<script>
    import {setPage} from '$lib/book/singletons.js'
    ...
    import BevinsBolt from '$lib/content/bevins-lineage/bevins-bolt/BevinsBolt.svelte'
    import BevinsBoltUSFC from '$lib/content/bevins-lineage/bevins-bolt/BevinsBoltCensus.svelte'
